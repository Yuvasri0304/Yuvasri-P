...
export const DATA = {
  ...
  work: [
    ...
    },
    {
      ...
      description:
        "Developed and maintained full-stack web applications, building scalable and responsive user interfaces with React and TypeScript. Designed and implemented RESTful APIs using Node.js and Express, ensuring seamless communication between frontend and backend services. Optimized database queries in PostgreSQL to improve performance and scalability. Collaborated with cross-functional teams to enhance application features and user experience.",
    },
    // {
    //   company: "Nvidia",
